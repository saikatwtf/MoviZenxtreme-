    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/MoviZeniX"),
                        InlineKeyboardButton("Bots Channel", url="https://t.me/MoviZenX")
                    ],
                    [
        ...
        try:
            ...
            await send_stored_file.reply_text(
                f"**Here is Sharable Link of this file:** https://t.me/{Config.BOT_USERNAME}?start=MoviZenX_{file_id}\n\n__To Retrive the Stored File, just open the link!__",
...
async def main(bot: Client, message: Message):
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/MoviZeniX)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=MoviZenX_{file_er_id}"
            await editable.edit(
    ...
    if "aboutbot" in cb_data:
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Channel of Bot",
                                             url="https://t.me/MoviZenX")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/MoviZeniX).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
